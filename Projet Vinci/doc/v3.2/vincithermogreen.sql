...
--
-- Base de données :  `vincithermogreen`
--
...
INSERT INTO `alerte` (`num_stade`, `num_zone`, `horodate`) VALUES
...
CREATE TABLE `stade` (
  `id_stade` bigint(20) UNSIGNED NOT NULL,
...
INSERT INTO `stade` (`id_stade`, `nom_stade`, `temp_max`, `temp_min`) VALUES
(1, 'Stade Vélodrome', 53, 53),
(2, 'Parc Olympique Lyonnais', 53, 53),
(3, 'Stade Pierre-Mauroy', 53, 51),
(4, 'Parc des Princes', 53, 53),
(5, 'Matmut Atlantique', 53, 53);
...
('amassa', '$2a$10$SltFZTNsbcKqohogkiil7uVRnVgAhofXlopUjY6ht1cRolmVaBfva', 'Alexis', 'Massa', '+33688137360', 'alexis.massa351@gmail.com', 1),
('pdupont', '$2y$10$BC9tFt96Bk/FohkNrspMCO1Wa02RvBLFdCkyZixkfGrg2OdkmKUPy', 'Pierre', 'Dupont', '+33688137360', 'pierre.dupont462@gmail.com', 0),
('jdutrou', '$2a$10$YS.E2ZmHb2d.Huz9GkGZbOFnp0j28MHSEnIQ4/vUw36R0jNPHfEba', 'Jacques', 'Dutrou', '+33688137362', 'jacques.dutrou@gmail.com', 0);
...
--
ALTER TABLE `alerte`
  ADD PRIMARY KEY (`num_stade`,`num_zone`,`horodate`);
...
ALTER TABLE `stade`
  ...
  ADD UNIQUE KEY `id_stade` (`id_stade`);
...
--
ALTER TABLE `stade`
  MODIFY `id_stade` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
COMMIT;
