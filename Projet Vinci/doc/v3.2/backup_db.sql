...
--
-- Hôte : 127.0.0.1:3306
-- Généré le : Dim 13 déc. 2020 à 16:31
...
CREATE TABLE IF NOT EXISTS `alerte` (
  ...
  PRIMARY KEY (`num_stade`,`num_zone`,`horodate`)
...
('amassa', 'pwdmassa', 'Alexis', 'Massa', '0688137360', 'alexis.massa351@gmail.com'),
('pdupont', 'pwddupont', 'Pierre', 'Dupont', '0688137360', 'pierre.dupont462@gmail.com');
COMMIT;
